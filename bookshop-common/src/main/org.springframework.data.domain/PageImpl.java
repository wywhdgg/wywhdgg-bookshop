...
public class PageImpl<T> extends Chunk<T> implements Page<T> {
	...
	public <S> Page<S> map(Converter<? super T, ? extends S> converter) {
		return new org.springframework.data.domain.PageImpl<S>(getConvertedContent(converter), pageable, total);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof org.springframework.data.domain.PageImpl<?>)) {
			return false;
		}

		org.springframework.data.domain.PageImpl<?> that = (org.springframework.data.domain.PageImpl<?>) obj;
