...
public class Sort implements Iterable<Sort.Order>, Serializable {
	...
	/**
	 * Creates a new {@link org.springframework.data.domain.Sort} instance using the given {@link Order}s.
	 *
	...
	/**
	 * Creates a new {@link org.springframework.data.domain.Sort} instance.
	 *
	...
	/**
	 * Creates a new {@link org.springframework.data.domain.Sort} instance. Order defaults to {@value Direction#ASC}.
	 *
	...
	/**
	 * Returns a new {@link org.springframework.data.domain.Sort} consisting of the {@link Order}s of the current {@link org.springframework.data.domain.Sort} combined with the given
	 * ones.
	 *
	...
	public org.springframework.data.domain.Sort and(org.springframework.data.domain.Sort sort) {
		...
		return new org.springframework.data.domain.Sort(these);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof org.springframework.data.domain.Sort)) {
			return false;
		}

		org.springframework.data.domain.Sort that = (org.springframework.data.domain.Sort) obj;
	...
	public static class Order implements Serializable {
		 ...
		 * {@link org.springframework.data.domain.Sort#DEFAULT_DIRECTION}
		 *
		 * @param direction can be {@literal null}, will default to {@link org.springframework.data.domain.Sort#DEFAULT_DIRECTION}
		...
		/**
		 * Returns a new {@link org.springframework.data.domain.Sort} instance for the given properties.
		 *
		 * @param properties
		 * @return
		 */
		public org.springframework.data.domain.Sort withProperties(String... properties) {
			return new org.springframework.data.domain.Sort(this.direction, properties);
		}
